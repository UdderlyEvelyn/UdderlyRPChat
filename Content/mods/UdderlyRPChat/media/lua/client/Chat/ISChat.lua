...
ISChat.allChatStreams[6] = {name = "faction", command = "/faction ", shortCommand = "/f ", tabID = 3};
ISChat.allChatStreams[7] = {name = "safehouse", command = "/safehouse ", shortCommand = "/sh ", tabID = 1};
ISChat.allChatStreams[8] = {name = "general", command = "/radio ", shortCommand = "/r ", tabID = 2};
ISChat.allChatStreams[9] = {name = "admin", command = "/admin ", shortCommand = "/a ", tabID = 4};
...
ISChat.allChatStreams[12] = {name = "dolow", command = "/dolow ", shortCommand = "/dl ", tabID = 1};
ISChat.allChatStreams[13] = {name = "do", command = "/do ", shortCommand = "/d ", tabID = 1};
ISChat.allChatStreams[14] = {name = "name", command = "/name ", shortCommand = "/rpname ", tabID = 1};
ISChat.allChatStreams[15] = {name = "ooc", command = "/ooc ", shortCommand = "/o ", tabID = 1};
ISChat.allChatStreams[16] = {name = "event", command = "/event ", shortCommand = "/e ", tabID = 5};
ISChat.allChatStreams[17] = {name = "low", command = "/low ", shortCommand = "/l ", tabID = 1};
ISChat.allChatStreams[18] = {name = "mehigh", command = "/mehigh ", shortCommand = "/mh ", tabID = 1};
ISChat.allChatStreams[19] = {name = "dohigh", command = "/dohigh ", shortCommand = "/dh ", tabID = 1};
ISChat.allChatStreams[20] = {name = "chat", command = "/chat ", shortCommand = "/c ", tabID = 5};
...
ISChat.defaultTabStream[3] = ISChat.allChatStreams[20];
ISChat.defaultTabStream[4] = ISChat.allChatStreams[6];
ISChat.defaultTabStream[5] = ISChat.allChatStreams[9];
...
function ISChat:onCommandEntered()
    ...
    if not commandProcessed then
        ...
        elseif chatStreamName == "pm" then
            ...
            proceedPM(final)
        -- .
        elseif chatStreamName == "event" then
        ...
        elseif chatStreamName == "ooc" then
        ...
        -- .
        elseif chatStreamName == "radio" then
            --[[
            if SandboxVars.RoleplayChat.ToggleOOC and not isAdmin() then
                getPlayer():addLineChatElement("Global OOC has been disabled by an Admin.", 1, 0, 0);
                doKeyPress(false);
